...
from code.Const import TEXT_MENU_C, TEXT_MENU_C_SELECT, PLAYER_OPTION, PLAYER_OPTION_POSITION
...
class OptionPlayer:
    def __init__(self, screen: Surface):
        ...
        self.player_option1 = py.transform.scale_by(self.player_option1, 3)
        self.player_option1_rect = self.player_option1.get_rect(left=PLAYER_OPTION_POSITION[PLAYER_OPTION[0]],top=200)
        # player option 2
        self.player_option2 = py.image.load('./assets/Player/Player2/Attack2/Attack1.png').convert_alpha()
        self.player_option2 = py.transform.scale_by(self.player_option2, 3)
        self.player_option2_rect = self.player_option2.get_rect(left=PLAYER_OPTION_POSITION[PLAYER_OPTION[1]],top=200)
    ...
    def run(self):
        ...
        while True:
            ...
            for i in range(len(PLAYER_OPTION)):
                if i == option:
                    self.option_text(40, PLAYER_OPTION[i], TEXT_MENU_C_SELECT, (PLAYER_OPTION_POSITION[PLAYER_OPTION[i]] + 40, 430))
                else:
                    self.option_text(40, PLAYER_OPTION[i], TEXT_MENU_C, (PLAYER_OPTION_POSITION[PLAYER_OPTION[i]] + 40, 430))
