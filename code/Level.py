...
from code.Const import TEXT_MENU_C, SCREEN_WIDTH, FIRST_SPAW, INTERVAL_SPAW, \
    ENTITY_HEALTH, COLOR_BAR_HP, COLOR_BAR_HP_BACK, BAR_HP_MAX, COLOR_BLACK
...
class Level:
    ...
    def run(self):
        ...
        while True:
            ...
            if self.name == 'Level1':
                for text in self.text_bubble_list:
                    ...
                    if time_actual <= self.time_creation + 2000:
                        self.text_bubble_list[0].create = True
            ...
            EntityMediator.verify_distance_entity(entity_list=self.entity_list)
